...
class SceneView @JvmOverloads constructor(
    ...
    private fun clickselectItem(eventX: Float, eventY: Float) {
        ...
        for (i in items.indices.reversed()) {
            ...
            when (item) {
                is Item -> {
                    ...
                    (context as? com.example.chot_tv.test_chucnang_tudo.MainActivity)?.showControlPanel(true)
        ...
        selectItem(null)
        (context as? com.example.chot_tv.test_chucnang_tudo.MainActivity)?.showControlPanel(false)
    }
